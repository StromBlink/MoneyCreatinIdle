	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				//MatCap
				#if defined(TCP2_MATCAP)
				fixed3 matcap = tex2D(_MatCapTex, input.pack2.zw).rgb * __matcapColor;
				emission += matcap;
				#endif
...
/* TCP_DATA u config(unity:"2019.4.22f1";ver:"2.7.2";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","SPEC_LEGACY","SPECULAR","SPECULAR_TOON","RIM","TEMPLATE_LWRP","SHADOW_COLOR_LERP","SPECULAR_SHADER_FEATURE","RIM_SHADER_FEATURE","REFLECTION_CUBEMAP","REFLECTION_SHADER_FEATURE","MATCAP_ADD","MATCAP","MATCAP_SHADER_FEATURE","BUMP","BUMP_SHADER_FEATURE"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,,sp(name:"Ramp Threshold";imps:list[imp_mp_range(def:0.5;min:0;max:1;prop:"_RampThreshold";md:"";gbv:False;custom:False;refs:"";guid:"314d49f5-81f7-41c8-9cea-7bdd6f9e2061";op:Multiply;lbl:"Threshold";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"Ramp Smoothing";imps:list[imp_mp_range(def:0.1;min:0.001;max:1;prop:"_RampSmoothing";md:"";gbv:False;custom:False;refs:"";guid:"0e926a6d-4108-4db1-b4d9-0b29a501ce77";op:Multiply;lbl:"Smoothing";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH b54eeeb2d4a63803610be80dc4c32cdf */
